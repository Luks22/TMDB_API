                            ...
                            <tbody>
          					<c:forEach var="filme" items="${lista}">
                                       ...
                                       <c:if test="${not empty filme.imagem}">
                                       		<td>
                                       			<img alt = "?" src="img/${filme.posterPath}" height="48" width="48" class="img-thumbnail">
                                       		</td>
                                       </c:if>
                                       <c:if test="${empty filme.imagem}">
                                       		<td>
                                       			<img alt = "?" src="${filme.posterPath}" height="48" width="48" class="img-thumbnail">
                                       		</td>
                                       </c:if>
                                            <td>
                                               ${filme.id }
