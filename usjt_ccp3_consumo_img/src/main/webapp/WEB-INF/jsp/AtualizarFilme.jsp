		...
		<form action="atualizar_filme" method="post"
			...
			<div class="row">
				<div class="form-group col-md-4">
					<input type="hidden" name="id" value="${filme.id}"> <label
						for="genero">Gênero</label> <select class="form-control"
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					<label for="dataLancamento">Lançamento</label> <input type="text"
						...
						value="<fmt:formatDate value="${filme.dataLancamento}" pattern="dd/MM/yyyy"/>">
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-8">
					<label for="posterpath">Poster</label> <input type="text"
						...
						maxlength="200" placeholder="caminho da imagem do poster"
						value="${filme.posterPath }">
				</div>

				<div class="form-group col-md-8">
					<label for="posterpath">Imagem</label> <input type="file"
						class="form-control" name="file" id="posterpath" maxlength="200"
				...
				<div class="form-group col-md-4">
					<label for="popularidade">Popularidade</label> <input type="number"
						...
						step="0.01" min="0.0" max="1000.0" value="${filme.popularidade }">
				</div>
			</div>
			<hr />
